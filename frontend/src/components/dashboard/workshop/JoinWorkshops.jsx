...
const JoinWorkshops = () => {
  ...
  const upcomingWorkshops = [
    ...
    },
    {
      ...
      host: "Dr. Bikash Poudel",
      hostBadge: "Guru",
      date: "2025-06-20",
      time: "1:00 PM - 4:00 PM",
      totalSeats: 20,
      registered: 15,
      zoomStatus: "Link will be shared 1 hour before",
      description:
        "Dive into machine learning concepts and build your first ML models using Python, TensorFlow, and real-world datasets.",
      outcomes: [
      ...
      hostBio:
        "PhD in Computer Science, AI researcher at Kathmandu University with 10+ publications in ML.",
      rules: [
        "Python basics required",
        "Jupyter notebook setup needed",
  ...
  const recommendedWorkshops = [
    {
      ...
      progressionNote: "You know MERN → Learn Docker",
      recommendation:
        "Perfect next step to deploy your web applications efficiently",
      skillUpNext: true,
      totalSeats: 15,
      registered: 8,
      description:
        "Learn containerization and deployment strategies to take your development skills to the next level.",
      outcomes: [
      ...
      hostBio:
        "DevOps Engineer at CloudFactory with extensive experience in containerization and cloud deployment.",
      rules: [
    ...
    },
    {
      ...
      progressionNote: "Master React fundamentals → Advanced patterns",
      recommendation:
        "Based on your React experience, dive deeper into advanced concepts",
      totalSeats: 18,
      registered: 12,
      description:
        "Explore advanced React patterns, custom hooks, and architectural decisions for large-scale applications.",
      outcomes: [
        "Master custom hooks",
      ...
      hostBio:
        "Senior Frontend Architect at Evolve with expertise in building large-scale React applications.",
      rules: [
        "Solid React foundation required",
  ...
  const WorkshopCard = ({ workshop, isRecommended = false }) => (
    <div className="card bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-gray-200 hover:border-blue-300">
      <div className="flex justify-between items-start mb-4">
        ...
        {isRecommended && workshop.skillUpNext && (
      ...
      {isRecommended && workshop.progressionNote && (
        <div className="mb-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-center gap-2 text-sm text-blue-700">
            <ChevronRight size={14} />
            <span className="font-medium">{workshop.progressionNote}</span>
          </div>
        </div>
      )}
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">{workshop.host}</span>
          <span
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">
            {workshop.registered}/{workshop.totalSeats} registered
          </span>
          <div className="flex-1 bg-gray-200 rounded-full h-2 ml-2">
            <div
              className="bg-blue-500 rounded-full h-2"
              style={{
                width: `${(workshop.registered / workshop.totalSeats) * 100}%`,
              }}
            ></div>
          </div>
        </div>
        ...
        {isRecommended && workshop.recommendation && (
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-2xl">
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-gray-600">{workshop.host}</span>
                <span
                  className={`px-2 py-1 rounded-full text-xs font-semibold border ${getBadgeColor(
                    workshop.hostBadge
                  )}`}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gray-50 p-4 rounded-xl">
              ...
              <p className="text-gray-700">{formatDate(workshop.date)}</p>
            ...
            <div className="bg-gray-50 p-4 rounded-xl">
              ...
              <p className="text-sm text-gray-500">
                {workshop.totalSeats - workshop.registered} seats remaining
              </p>
            </div>
          </div>
