      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center mb-4">
            <div className="bg-blue-600 p-3 rounded-full" style={{backgroundColor: '#2A66DE'}}>
          ...
          <p className="text-gray-600 text-lg">
            Empowering Nepali Students to <span className="font-semibold" style={{color: '#2A66DE'}}>Learn</span>, 
            <span className="font-semibold" style={{color: '#2A66DE'}}> Teach</span>, and 
            <span className="font-semibold" style={{color: '#2A66DE'}}> Earn</span>
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onFocus={(e) => e.target.style.setProperty('--tw-ring-color', '#2A66DE')}
            ...
            <button
              ...
              style={{backgroundColor: '#2A66DE', '--tw-ring-color': '#2A66DE'}}
            >
              {isLoading ? (
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-center text-gray-600 text-sm mb-4">What awaits you:</p>
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="flex flex-col items-center">
                <div className="bg-gray-100 p-2 rounded-full mb-2">
                  <DollarSign className="h-4 w-4" style={{color: '#2A66DE'}} />
                </div>
